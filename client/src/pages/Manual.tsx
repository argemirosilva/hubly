  ...
  },
  {
    ...
    topics: [
      ...
      },
      {
        ...
        tip: "O saldo de crédito também aparece como um KPI no perfil da cliente e como badge verde na listagem de Clientes, facilitando a identificação rápida de quem tem saldo disponível.",
    ...
    topics: [
      {
        ...
        steps: [
          ...
          "Agendamento criado — envia confirmação imediata ao cliente.",
          "Pré-agendamento criado — envia solicitação de reserva ou aviso de aguardo.",
          "Reserva paga — envia confirmação de que a reserva foi recebida.",
          "1 dia antes do agendamento — envia lembrete automático.",
          "Aniversário do mês — envia mensagem no dia 1º do mês do aniversário (1x por ano).",
          "Profissional atribuído — avisa o cliente quando um profissional é definido para o agendamento.",
      ...
      },
      {
        ...
        tip: "Variáveis disponíveis: {{nome_cliente}}, {{primeiro_nome}}, {{data}}, {{hora}}, {{servico}}, {{profissional}}, {{empresa}}, {{valor}}, {{valor_reserva}}. O sistema substitui automaticamente pelos dados reais.",
      },
      {
        title: "Templates prontos",
        steps: [
          "Na tela de Automações, clique em Templates para ver os modelos prontos.",
          "Disponíveis: Lembrete 24h antes, Aniversário do Mês, Solicitar Reserva, Reserva paga, Profissional atribuído, Natal e outros.",
          "Clique em um template para usá-lo como ponto de partida.",
          "Personalize o texto e ative.",
        ],
        tip: "Os templates já vêm com o gatilho e a mensagem pré-configurados. É a forma mais rápida de começar!",
      },
      {
