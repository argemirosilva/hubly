    ...
    topics: [
      {
        ...
        steps: [
          ...
          "Escolha a data de início e a data de fim (pode ser o mesmo dia ou um período de vários dias).",
          "Escolha o tipo de bloqueio: Dia inteiro ou Horário específico.",
          "Se escolher Horário específico, informe a hora de início e a hora de fim.",
          "Escreva o motivo (ex: Férias, Consulta médica, Treinamento).",
      ...
      {
        title: "Dia inteiro vs. Horário específico",
        steps: [
          "Dia inteiro: bloqueia o dia completo (das 00:00 às 23:59). Ideal para férias, folgas e feriados.",
          "Horário específico: bloqueia apenas um intervalo do dia. Ideal para consultas, compromissos ou pausas.",
          "Quando 'Dia inteiro' está selecionado, os campos de hora ficam ocultos — não é necessário preenchê-los.",
          "Na listagem de bloqueios, os bloqueios de dia inteiro exibem o badge 'Dia inteiro' para fácil identificação.",
        ],
        tip: "Para bloquear uma semana de férias, selecione data início e data fim e escolha 'Dia inteiro'. O sistema criará automaticamente um bloqueio para cada dia do período.",
      },
      {
        title: "Bloqueio de período (múltiplos dias)",
        steps: [
          "Selecione uma data de início e uma data de fim diferentes.",
          "Um aviso aparecerá informando: 'Período de X dias — será criado um bloqueio para cada dia'.",
          "Ao confirmar, o sistema cria automaticamente um bloqueio individual para cada dia do intervalo.",
          "Cada bloqueio pode ser aprovado, recusado ou cancelado individualmente.",
        ],
        tip: "Isso é útil para bloquear férias de uma semana ou um feriado prolongado de uma só vez, sem precisar criar cada dia manualmente.",
      },
      {
      ...
      {
        title: "Filtros na listagem de bloqueios",
        steps: [
          "Todos: exibe todos os bloqueios da empresa.",
          "Meus Bloqueios: exibe apenas os bloqueios do profissional logado.",
          "Aguardando Aprovação: exibe bloqueios pendentes de outros profissionais (visível apenas para administradores).",
          "Histórico: exibe bloqueios já aprovados ou recusados.",
        ],
        tip: "Um contador vermelho aparece no filtro 'Aguardando Aprovação' quando há bloqueios pendentes de aprovação.",
      },
    ],
  },
  {
